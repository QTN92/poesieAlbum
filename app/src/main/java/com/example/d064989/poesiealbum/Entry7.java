...
public class Entry7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_entry7);
    ...
    public void onClicked(View aView) {
        if (aView.getId() == R.id.back) {
            Intent back = new Intent(this, Entry6.class);
            startActivity(back);
        } else {
            Intent next = new Intent(this, Entry8.class);
            startActivity(next);
        }
    }
}
