...
public class Entry9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_entry9);
    ...
    public void onClicked(View aView) {
        if (aView.getId() == R.id.back) {
            Intent back = new Intent(this, Entry8.class);
            startActivity(back);
        } else {
            Intent next = new Intent(this, Entry10.class);
            startActivity(next);
        }
    }
