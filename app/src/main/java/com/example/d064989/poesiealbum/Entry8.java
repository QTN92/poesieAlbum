...
public class Entry8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_entry8);
    ...
    public void onClicked(View aView) {
        if (aView.getId() == R.id.back) {
            Intent back = new Intent(this, Entry7.class);
            startActivity(back);
        } else {
            Intent next = new Intent(this, Entry9.class);
            startActivity(next);
        }
    }
